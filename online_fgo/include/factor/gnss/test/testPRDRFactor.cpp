...
TEST(CarrierPhaseFactor, Constructor) {
  ...
  gtsam::Matrix H1e = gtsam::numericalDerivative11<gtsam::Vector, gtsam::Pose3>(
    boost::bind(&fgo::factors::GnssFactor::evaluateError, &factor, boost::placeholders::_1, vel, cbd, boost::none,
                boost::none, boost::none), poseRec);
  gtsam::Matrix H2e = gtsam::numericalDerivative11<gtsam::Vector, gtsam::Vector3>(
    boost::bind(&fgo::factors::GnssFactor::evaluateError, &factor, poseRec, boost::placeholders::_1, cbd, boost::none,
                boost::none, boost::none), vel);
  gtsam::Matrix H3e = gtsam::numericalDerivative11<gtsam::Vector, gtsam::Vector2>(
    boost::bind(&fgo::factors::GnssFactor::evaluateError, &factor, poseRec, vel, boost::placeholders::_1, boost::none,
                boost::none, boost::none), cbd);
  gtsam::Matrix66 E2B = (gtsam::Matrix66()
    << gtsam::I_3x3, gtsam::Z_3x3, gtsam::Z_3x3, poseRec.rotation().matrix()).finished();
  H1e = H1e *
