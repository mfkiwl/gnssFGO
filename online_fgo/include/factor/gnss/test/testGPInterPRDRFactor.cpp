...
//create factor
  fgo::factors::GPInterpolatedPRDRFactor factor(1, 2, 3, 4, 5, pseuRa, dPseuRa, pointSat, velSat, lb, omega1, omega2,
                                                deltat,
...
//check error
  ...
  gtsam::Matrix66 E2B = (gtsam::Matrix66()
    << gtsam::I_3x3, gtsam::Z_3x3, gtsam::Z_3x3, poseReci.rotation().matrix()).finished();
