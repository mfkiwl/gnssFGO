...
namespace fgo::factors {
  class GPInterpolatedDDPseuRaFactorO : public gtsam::NoiseModelFactor6<gtsam::Pose3,
  ...
  private:
    ...
    typedef GPInterpolatedDDPseuRaFactorO This;
  ...
  public:
    ...
    GPInterpolatedDDPseuRaFactorO() {}

    //when meausrment are already known when build
    GPInterpolatedDDPseuRaFactorO(const gtsam::Key &point_i, const gtsam::Key &vel_i, const gtsam::Key &omega_i,
    ...
    virtual ~GPInterpolatedDDPseuRaFactorO() {}
...
namespace gtsam {
  template<>
  struct traits<fgo::factors::GPInterpolatedDDPseuRaFactorO> :
    public Testable<fgo::factors::GPInterpolatedDDPseuRaFactorO> {
  };
}