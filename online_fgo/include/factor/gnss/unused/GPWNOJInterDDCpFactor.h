...
namespace fgo::factor {
  ...
  class GPWNOJInterpolatedDDCpFactor
    : public fgo::NoiseModelFactor9<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
  ...
  public:
    ...
    GPWNOJInterpolatedDDCpFactor(const gtsam::Key &point_i, const gtsam::Key &vel_i, const gtsam::Key &omega_i,
      ...
      Interpolator(model, point_i, vel_i, omega_i, acc_i, point_j, vel_j, omega_j, acc_j, ambiguity_j),
      ddphi_(ddCarPha),
    ...
    evaluateError(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1,
                  ...
                  const gtsam::Vector6 &acc2, const gtsam::Vector &ddambiguity_j,
        ...
        if (H8)
          *H8 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
            std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2,
                      std::placeholders::_1, ddambiguity_j), acc2);
        if (H9) {
    ...
    evaluateError_(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1,
                   const gtsam::Vector6 &acc1,
                   const gtsam::Pose3 &pose2, const gtsam::Vector3 &vel2, const gtsam::Vector3 &omega2,
                   const gtsam::Vector6 &acc2, const gtsam::Vector &ddambiguity_j) const {
      gtsam::Pose3 poseBody; //interpolated position
