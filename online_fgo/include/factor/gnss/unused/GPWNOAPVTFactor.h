...
#ifndef ONLINE_FGO_GPWNOAPVTFACTOR_H
#define ONLINE_FGO_GPWNOAPVTFACTOR_H
...
namespace fgo::factor {
  class GPWNOAPVTFactor : public gtsam::NoiseModelFactor6<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3,
  ...
  public:
    GPWNOAPVTFactor() = default;

    GPWNOAPVTFactor(const gtsam::Key &poseKeyI, const gtsam::Key &velKeyI, const gtsam::Key &omegaKeyI,
    ...
    evaluateError(const gtsam::Pose3 &poseI, const gtsam::Vector3 &velI, const gtsam::Vector3 &omegaI,
      ...
      if (useAutoDiff_) {
        ...
        gtsam::Matrix Hint1_P, Hint2_P, Hint3_P, Hint4_P, Hint5_P, Hint6_P, Hpose, Hrot, Hvele;
  ...
  private:
    ...
    void serialize(ARCHIVE &ar, const unsigned int version) {
      ar & boost::serialization::make_nvp("GPWNOAPVTFactor",
...
namespace gtsam {
  template<>
  struct traits<fgo::factor::GPWNOAPVTFactor> : public Testable<fgo::factor::GPWNOAPVTFactor> {
  };
}
#endif //ONLINE_FGO_GPWNOAPVTFACTOR_H
