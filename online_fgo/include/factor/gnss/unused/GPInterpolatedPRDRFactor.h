  ...
  public:
    ...
    gtsam::Vector evaluateError(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector2 &cbd1,
      ...
      if (H1 || H2 || H4 || H5) {
        ...
        gtsam::Matrix16 dDrdVel = (gtsam::Matrix16()
          << 0, 0, 0, e).finished(); //not dependent on omega because angularrate comes from sensor
        ...
        Hint2 = Hint2.block<6, 3>(0, 3);
        Hint2v = Hint2v.block<6, 3>(0, 3);
        Hint4 = Hint4.block<6, 3>(0, 3);
        Hint4v = Hint4v.block<6, 3>(0, 3);
