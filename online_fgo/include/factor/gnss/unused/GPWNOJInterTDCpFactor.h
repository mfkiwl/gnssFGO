...
#ifndef ONLINE_FGO_GPWNOJINTERTDCPFACTOR_H
#define ONLINE_FGO_GPWNOJINTERTDCPFACTOR_H
...
namespace fgo::factor {
  ...
  private:
    ...
    typedef GPWNOJInterTDCpFactor This;
    typedef fgo::NoiseModelFactor8<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
      gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6> Interpolator;

  public:
    //Standard Constructor
    GPWNOJInterTDCpFactor() = default;

    //Constructor for between two states
    GPWNOJInterTDCpFactor(gtsam::Key point_1, gtsam::Key vel_1, gtsam::Key omega_1, gtsam::Key acc_1,
                          gtsam::Key point_2, gtsam::Key vel_2, gtsam::Key omega_2, gtsam::Key acc_2,
      ...
      Interpolator(model, point_1, vel_1, omega_1, acc_1, point_2, vel_2, omega_2, acc_2),
    ...
    ~GPWNOJInterTDCpFactor() override = default;
    ...
    evaluateError(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1,
      ...
      if (H1)
        *H1 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Pose3>(
          boost::bind(&This::evaluateError_, this, boost::placeholders::_1, vel1, omega1, acc1, pose2, vel2, omega2,
                      acc2),
          pose1);
      if (H2)
        *H2 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
          boost::bind(&This::evaluateError_, this, pose1, boost::placeholders::_1, omega1, acc1, pose2, vel2, omega2,
                      acc2),
          vel1);
      if (H3)
        *H3 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
          boost::bind(&This::evaluateError_, this, pose1, vel1, boost::placeholders::_1, acc1, pose2, vel2, omega2,
                      acc2),
          omega1);

      if (H4)
        *H4 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector6>(
          boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, boost::placeholders::_1, pose2, vel2, omega2,
                      acc2),
          acc1);

      if (H5)
        *H5 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Pose3>(
          boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, boost::placeholders::_1, vel2, omega2,
                      acc2),
          pose2);
      if (H6)
        *H6 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
          boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, boost::placeholders::_1, omega2,
                      acc2),
          vel2);
      if (H7)
        *H6 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
          boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, boost::placeholders::_1,
                      acc2),
          omega2);

      if (H8)
        *H8 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector6>(
          boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2,
    ...
    evaluateError_(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1,
      ...
      poseBodyi = GPbasei_->interpolatePose(pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2);
      poseBodyj = GPbasej_->interpolatePose(pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2);
  ...
  class GPWNOJInterpolated3TDCpFactor
    : public fgo::NoiseModelFactor12<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
      gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6> {
  ...
  private:
    ...
    std::shared_ptr<fgo::models::GPInterpolator> GPbasei_, GPbasej_; //Interpolator
    typedef GPWNOJInterpolated3TDCpFactor This;
    typedef fgo::NoiseModelFactor12<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
      gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
      gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6> Interpolator;

  public:

    GPWNOJInterpolated3TDCpFactor() = default;

    GPWNOJInterpolated3TDCpFactor(gtsam::Key point_i, gtsam::Key vel_i, gtsam::Key omega_i, gtsam::Key acc_i,
                                  gtsam::Key point_j, gtsam::Key vel_j, gtsam::Key omega_j, gtsam::Key acc_j,
                                  gtsam::Key point_k, gtsam::Key vel_k, gtsam::Key omega_k, gtsam::Key acc_k,
                                  const double &ddphi_i, const double &ddphi_j,
                                  const gtsam::Point3 &pointMaster_i, const gtsam::Point3 &pointSatI_i,
                                  const gtsam::Point3 &pointMaster_j, const gtsam::Point3 &pointSatI_j,
                                  const gtsam::Point3 &pointBase, const gtsam::Point3 &lb, const double &lambda,
                                  ...
                                  const std::shared_ptr<fgo::models::GPInterpolator> &interpolator_i,
                                  const std::shared_ptr<fgo::models::GPInterpolator> &interpolator_j) :
      Interpolator(model, point_i, vel_i, omega_i, acc_i, point_j, vel_j, omega_j, acc_j, point_k, vel_k, omega_k,
                   acc_k),
    ...
    ~GPWNOJInterpolated3TDCpFactor() override = default;
    ...
    evaluateError(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1,
      ...
      if (H1)
        *H1 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Pose3>(
          std::bind(&This::evaluateError_, this, std::placeholders::_1, vel1, omega1, acc1, pose2, vel2, omega2, acc2,
                    pose3, vel3, omega3, acc3), pose1);

      if (H2) {
        *H2 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
          std::bind(&This::evaluateError_, this, pose1, std::placeholders::_1, omega1, acc1, pose2, vel2, omega2, acc2,
                    pose3, vel3, omega3, acc3), vel1);
      }

      if (H3) {
        *H3 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, std::placeholders::_1, acc1, pose2, vel2, omega2, acc2,
                    pose3, vel3, omega3, acc3), omega1);
      }

      if (H4) {
        *H4 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, std::placeholders::_1, pose2, vel2, omega2, acc2,
                    pose3, vel3, omega3, acc3), acc1);
      }

      if (H5)
        *H5 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Pose3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, std::placeholders::_1, vel2, omega2, acc2,
                    pose3, vel3, omega3, acc3), pose2);

      if (H6) {
        *H6 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, std::placeholders::_1, omega2, acc2,
                    pose3, vel3, omega3, acc3), vel2);
      }

      if (H7) {
        *H7 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, std::placeholders::_1, acc2,
                    pose3, vel3, omega3, acc3), omega2);
      }

      if (H8) {
        *H8 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, std::placeholders::_1,
                    pose3, vel3, omega3, acc3), acc2);
      }

      if (H9)
        *H9 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Pose3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2,
                    std::placeholders::_1, vel3, omega3, acc3), pose3);

      if (H10) {
        *H10 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3,
                    std::placeholders::_1, omega3, acc3), vel3);
      }

      if (H11) {
        *H11 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3,
                    std::placeholders::_1, acc3), omega3);
      }

      if (H12) {
        *H12 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
          std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3,
                    omega3, std::placeholders::_1), acc3);
      }

      return evaluateError_(pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3);
    }
    ...
    evaluateError_(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1,
                   ...
                   const gtsam::Vector6 &acc2,
                   const gtsam::Pose3 &pose3, const gtsam::Vector3 &vel3, const gtsam::Vector3 &omega3,
                   const gtsam::Vector6 &acc3) const {

      gtsam::Pose3 positionBodyi = GPbasei_->interpolatePose(pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2);
      gtsam::Pose3 positionBodyj = GPbasej_->interpolatePose(pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3);
...
namespace gtsam {
  ...
  template<>
  struct traits<fgo::factor::GPWNOJInterTDCpFactor> :
    public Testable<fgo::factor::GPWNOJInterTDCpFactor> {
  };

}

#endif //ONLINE_FGO_GPWNOJINTERTDCPFACTOR_H
