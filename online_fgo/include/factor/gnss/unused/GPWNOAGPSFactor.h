...
#ifndef ONLINE_FGO_GPWNOAGPSFACTOR_H
#define ONLINE_FGO_GPWNOAGPSFACTOR_H
...
namespace fgo::factor {
  class GPWNOAGPSFactor : public gtsam::NoiseModelFactor6<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3,
  ...
  public:
    GPWNOAGPSFactor() = default;

    GPWNOAGPSFactor(const gtsam::Key &poseKeyI, const gtsam::Key &velKeyI, const gtsam::Key &omegaKeyI,
    ...
    ~GPWNOAGPSFactor() override = default;
    ...
    evaluateError(const gtsam::Pose3 &poseI, const gtsam::Vector3 &velI, const gtsam::Vector3 &omegaI,
      ...
      if (useAutoDiff_) {
        ...
        gtsam::Matrix Hint1_P, Hint2_P, Hint3_P, Hint4_P, Hint5_P, Hint6_P, Hpose, Hrot;
        ...
        const auto ePos = pose.translation(Hpose) + pose.rotation(Hrot).rotate(lb_) - pos_;
    ...
    void print(const std::string &s = "",
      ...
      std::cout << s << "GPWNOAPVTFactor" << std::endl;
...
namespace gtsam {
  template<>
  struct traits<fgo::factor::GPWNOAGPSFactor> : public Testable<fgo::factor::GPWNOAGPSFactor> {
  };
}

#endif //ONLINE_FGO_GPWNOAGPSFACTOR_H
