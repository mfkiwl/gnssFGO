...
#ifndef ONLINE_FGO_GPWNOAINTERTDCPFACTORNORMALCP_H
#define ONLINE_FGO_GPWNOAINTERTDCPFACTORNORMALCP_H
...
namespace fgo::factor {
  ...
  class GPWNOAInterpolatedTDNCPFactor : public fgo::NoiseModelFactor12<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3,
  ...
  private:
    ...
    typedef GPWNOAInterpolatedTDNCPFactor This;
  ...
  public:
    GPWNOAInterpolatedTDNCPFactor() = default;

    // ddmeasurements not known when constructed
    GPWNOAInterpolatedTDNCPFactor(
    ...
    GPWNOAInterpolatedTDNCPFactor(const gtsam::Key &point_0, const gtsam::Key &vel_0, const gtsam::Key &omega_0,
    ...
    ~GPWNOAInterpolatedTDNCPFactor() override = default;
...
namespace gtsam {
  template<>
  struct traits<fgo::factor::GPWNOAInterpolatedTDNCPFactor> :
    public Testable<fgo::factor::GPWNOAInterpolatedTDNCPFactor> {
  };
}
...
#endif //ONLINE_FGO_GPWNOAINTERTDCPFACTORNORMALCP_H
