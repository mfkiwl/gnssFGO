...
#ifndef ONLINE_FGO_GPWNOAINTERPRDRFACTOR_H
#define ONLINE_FGO_GPWNOAINTERPRDRFACTOR_H
...
namespace fgo::factor {
  ...
  class GPWNOAInterpolatedPrDrFactor : public NoiseModelFactor7<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3,
  ...
  private:
    ...
    typedef GPWNOAInterpolatedPrDrFactor This;
  ...
  public:
    ...
    GPWNOAInterpolatedPrDrFactor() = default; /* Default constructor */

    /**
     * Constructor
     * @param body_P_sensor transformation from body to sensor
     */
    GPWNOAInterpolatedPrDrFactor(gtsam::Key pose_i, gtsam::Key vel_i, gtsam::Key omega_i,
    ...
    ~GPWNOAInterpolatedPrDrFactor() override = default;
...
namespace gtsam {
  template<>
  struct traits<fgo::factor::GPWNOAInterpolatedPrDrFactor> :
    public Testable<fgo::factor::GPWNOAInterpolatedPrDrFactor> {
  };
}
