...
namespace fgo::factor {
  class GPSingerPriorPose3Full : public GPPriorBase,
  ...
  private:
    typedef GPSingerPriorPose3Full This;
  ...
  public:
    GPSingerPriorPose3Full() = default;

    GPSingerPriorPose3Full(
      ...
      factorName_ = "GPSingerPriorPose3FullFactor";
    }

    ~GPSingerPriorPose3Full() override = default;
...
namespace gtsam {
  template<>
  struct traits<fgo::factor::GPSingerPriorPose3Full> : public Testable<fgo::factor::GPSingerPriorPose3Full> {
  };
}
