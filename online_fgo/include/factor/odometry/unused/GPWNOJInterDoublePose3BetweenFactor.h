 ...
 */
  ...
  class GPWNOJInterDoublePose3BetweenFactor
    : public fgo::NoiseModelFactor16<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
  ...
  public:
    ...
    GPWNOJInterDoublePose3BetweenFactor(gtsam::Key pose1i, gtsam::Key vel1i, gtsam::Key omega1i, gtsam::Key acc1i,
      ...
      Base(model, pose1i, vel1i, omega1i, acc1i, pose1j, vel1j, omega1j, acc1j, pose2i, vel2i, omega2i, acc2i, pose2j,
           vel2j, omega2j, acc2j), GPbasePose1_(interpolatorPose1),
    ...
    evaluateError(const gtsam::Pose3 &p1i, const gtsam::Vector3 &v1i, const gtsam::Vector3 &omega1i,
      ...
      if (H1 || H2 || H3 || H4 || H5 || H6 || H7 || H8) {
        pose1 = GPbasePose1_->interpolatePose(p1i, v1i, omega1i, acc1i, p1j, v1j, omega1j, acc1j,
                                              Hint11_P, Hint12_P, Hint13_P, Hint14_P, Hint15_P, Hint16_P, Hint17_P,
                                              Hint18_P);
      } else
        pose1 = GPbasePose1_->interpolatePose(p1i, v1i, omega1i, acc1i, p1j, v1j, omega1j, acc1j);
      ...
      if (H9 || H10 || H11 || H12 || H13 || H14 || H15 || H16) {
        pose2 = GPbasePose2_->interpolatePose(p2i, v2i, omega2i, acc2i, p2j, v2j, omega2j, acc2j,
                                              Hint21_P, Hint22_P, Hint23_P, Hint24_P, Hint25_P, Hint26_P, Hint27_P,
                                              Hint28_P);
      } else
        pose2 = GPbasePose2_->interpolatePose(p2i, v2i, omega2i, acc2i, p2j, v2j, omega2j, acc2j);
...
/// traits
  template<>
  struct traits<fgo::factor::GPWNOJInterDoublePose3BetweenFactor>
    : public gtsam::Testable<fgo::factor::GPWNOJInterDoublePose3BetweenFactor> {
  };
