...
namespace fgo::factor {
  ...
  public:
    ...
    GPWNOJNavPoseFactor(gtsam::Key poseKeyI, gtsam::Key velKeyI, gtsam::Key omegaKeyI, gtsam::Key accKeyI,
      ...
      Base(model, poseKeyI, velKeyI, omegaKeyI, accKeyI, poseKeyJ, velKeyJ, omegaKeyJ, accKeyJ),
      poseMeasured_(poseMeasured), useAutoDiff_(useAutoDiff),
