...
namespace fgo::factor {
  ...
  public:
    ...
    GPWNOJNavAttitudeFactor(gtsam::Key poseKeyI, gtsam::Key velKeyI, gtsam::Key omegaKeyI, gtsam::Key accKeyI,
      ...
      rotMeasured_(rotMeasured), measuredRotFrame_(rotFrame),
      ...
      if (useAutoDiff_) {
        ...
        switch (measuredRotFrame_) {
          case MeasurementFrame::NED: {
            ...
            error = gtsam::Rot3::Logmap(rotNav.between(rotMeasured_, (H1 || H5) ? &D_dR_R : nullptr),
                                        (H1 || H5) ? &D_xi_R : nullptr);
            if (H1 || H5) {
