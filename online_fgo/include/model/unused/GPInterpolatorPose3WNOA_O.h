...
#ifndef ONLINE_FGO_GPINTERPOLATORPOSE3WNOA_O_H
#define ONLINE_FGO_GPINTERPOLATORPOSE3WNOA_O_H
 ...
 */
    class GaussianProcessInterpolatorPose3WNOA_O {

    private:
      typedef GaussianProcessInterpolatorPose3WNOA_O This;
    ...
    public:
      ...
      GaussianProcessInterpolatorPose3WNOA_O() {}
       ...
       */
      GaussianProcessInterpolatorPose3WNOA_O(const gtsam::SharedNoiseModel &Qc_model, double delta_t, double tau) :
      ...
      GaussianProcessInterpolatorPose3WNOA_O(const This& interpolator): delta_t_(interpolator.delta_t_),
      ...
      /** Virtual destructor */
      virtual ~GaussianProcessInterpolatorPose3WNOA_O() {}
      ...
      gtsam::Pose3 interpolatePose(
        ...
        if (H1)
          *H1 = gtsam::numericalDerivative11<gtsam::Pose3, gtsam::Pose3>(
                  boost::bind(&This::interpolatePose_, this, boost::placeholders::_1, omVel1, pose2, omVel2),
                  pose1, 1e-5);
        if (H2)
          *H2 = gtsam::numericalDerivative11<gtsam::Pose3, gtsam::Vector6>(
                  boost::bind(&This::interpolatePose_, this, pose1, boost::placeholders::_1, pose2, omVel2),
                  omVel1, 1e-5);
        if (H3)
          *H3 = gtsam::numericalDerivative11<gtsam::Pose3, gtsam::Pose3>(
                  boost::bind(&This::interpolatePose_, this, pose1, omVel1, boost::placeholders::_1, omVel2),
                  pose2, 1e-5);
        if (H4)
          *H4 = gtsam::numericalDerivative11<gtsam::Pose3, gtsam::Vector6>(
                  boost::bind(&This::interpolatePose_, this, pose1, omVel1, pose2, boost::placeholders::_1),
                  omVel2, 1e-5);
      ...
      gtsam::Pose3 interpolatePose_(
              const gtsam::Pose3 &pose1, const gtsam::Vector6 &omVel1,
              const gtsam::Pose3 &pose2, const gtsam::Vector6 &omVel2) const {
      ...
      gtsam::Vector6 interpolateVelocity(
        ...
        if (H1)
          *H1 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Pose3>(
                  boost::bind(&This::interpolateVelocity_, this, boost::placeholders::_1, omVel1, pose2, omVel2),
                  pose1, 1e-5);
        if (H2)
          *H2 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Vector6>(
                  boost::bind(&This::interpolateVelocity_, this, pose1, boost::placeholders::_1, pose2, omVel2),
                  omVel1, 1e-5);
        if (H3)
          *H3 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Pose3>(
                  boost::bind(&This::interpolateVelocity_, this, pose1, omVel1, boost::placeholders::_1, omVel2),
                  pose2, 1e-5);
        if (H4)
          *H4 = gtsam::numericalDerivative11<gtsam::Vector6, gtsam::Vector6>(
                  boost::bind(&This::interpolateVelocity_, this, pose1, omVel1, pose2, boost::placeholders::_1),
                  omVel2, 1e-5);
...
namespace gtsam {
  template<>
  struct traits<fgo::models::GaussianProcessInterpolatorPose3WNOA_O> : public Testable<
          fgo::models::GaussianProcessInterpolatorPose3WNOA_O> {};
}

#endif //ONLINE_FGO_GPINTERPOLATORPOSE3WNOA_O_H
